    ...
    <div class="chead">
      ...
      <div class="ct">
        ...
        <div class="pillrow">
          ...
          <span class="pill">${v.serving}</span><span class="pill">빈티지 ${v.vintages}</span></div>
      </div></div></div>`;
}
function renderList(){
...
function detailHTML(v){
  ...
  <div class="sbody">
    ...
    ${kv('고향',v.origin)}${kv('유래',v.lineage)}${kv('주요 산지',v.regions)}${kv('마리아주',v.mariage)}${kv('시음 온도',v.serving)}${kv('추천 빈티지',v.vintages)}
